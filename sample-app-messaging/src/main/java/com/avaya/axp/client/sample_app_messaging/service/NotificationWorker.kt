...
import com.avaya.axp.client.sample_app_messaging.MainActivity
...
import com.avaya.axp.client.sample_app_messaging.util.NOTIFICATION_CHANNEL_DESCRIPTION
import com.avaya.axp.client.sample_app_messaging.util.NOTIFICATION_CHANNEL_ID
import com.avaya.axp.client.sample_app_messaging.util.NOTIFICATION_CHANNEL_NAME
import com.avaya.axp.client.sample_app_messaging.util.NOTIFICATION_GROUP_KEY
...
import com.avaya.axp.client.sdk.core.Participant
import com.avaya.axp.client.sdk.core.ParticipantType
...
import com.avaya.axp.client.sdk.messaging.NotificationResult
...
suspend fun getMessagesList(
    ...
    if (AxpClientSdk.sdkConfig == null) {
        try {
    ...
    return when (val result = AxpMessaging.getNotificationData(notificationPayload)) {
        ...
        is AxpFailureResult -> {
            Log.d("NotificationWorker", "result = ${result.error}")
            emptyList()
        }
    }
}
