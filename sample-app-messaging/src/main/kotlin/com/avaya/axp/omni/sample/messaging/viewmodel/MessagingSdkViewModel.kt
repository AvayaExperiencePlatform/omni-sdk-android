package com.avaya.axp.omni.sample.messaging.viewmodel
...
import com.avaya.axp.omni.sample.messaging.BuildConfig
...
import com.avaya.axp.omni.sample.messaging.service.createNotificationBuilder
import com.avaya.axp.omni.sample.messaging.service.getSenderName
import com.avaya.axp.omni.sample.messaging.util.ADDRESS
...
import com.avaya.axp.omni.sample.messaging.util.CONTEXT_PARAMETERS
import com.avaya.axp.omni.sample.messaging.util.IMAGE_EMOJI
import com.avaya.axp.omni.sample.messaging.util.LATITUDE
import com.avaya.axp.omni.sample.messaging.util.LONGITUDE
...
import com.avaya.axp.omni.sdk.core.AxpSdkConfig
import com.avaya.axp.omni.sdk.core.AxpSuccessResult
import com.avaya.axp.omni.sdk.core.SdkConfigKey
import com.avaya.axp.omni.sdk.core.UserSession
import com.avaya.axp.omni.sdk.messaging.AxpMessaging
import com.avaya.axp.omni.sdk.messaging.ElementType
import com.avaya.axp.omni.sdk.messaging.EventState
import com.avaya.axp.omni.sdk.messaging.LocationMessage
import com.avaya.axp.omni.sdk.messaging.Message
import com.avaya.axp.omni.sdk.messaging.messageArrivedFlow
...
class MessagingSdkViewModel : ViewModel() {
    ...
    fun configureSdk(context: Context) {
        try {
            messagingSdkConfig = AxpOmniSdk.sdkConfig ?: AxpOmniSdk.configureSdk(
            ...
            log.warn("Failed to configure AxpOmniSdk: {}", e.summary)
        }
    }
...
//            onComplete(null)
    ...
    fun clear() {
        runBlocking {
            try {
                AxpOmniSdk.shutDown() is AxpSuccessResult
            } catch (e: Exception) {
