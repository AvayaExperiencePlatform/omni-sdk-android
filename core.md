...
The AXP Core module is a fundamental part of the Android version of the AXP Client SDK. The main
responsibility of the core is to over look session management. It provides
the essential logic for configuring the SDK. However,
this module is not standalone and works in conjunction with three other optional modules:

1. **AxpMessaging**
   : Enables text messaging to agents in AXP.

Developers can choose to include only the modules needed for their application and omit the others
if their functionality is not required.

## Installation

The AXP Core module is distributed as a Maven artifact. To include it in your project, add the
